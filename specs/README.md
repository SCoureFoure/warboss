...
| [e4-battery-authoring](e4-battery-authoring.spec.md) | E4: God answers escalations → warboss re-authors with locked decisions → re-run E2 on a neutral God-battery oracle; closes the kick-back loop end-to-end | Phase 4 follow-on (E3 consequence) | active |
